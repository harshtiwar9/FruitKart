...
//                alert("IN");
            ...
            function regal(status)
            {
                ...
                {
                    Materialize.toast("System Error Try Again!!",3000);
                }
        ...
        <div class="row" style>
            ...
            <div class="input-field col s10">
                ...
                if ($o != null && $k != null) {
                    ...
                    echo "<div class='input-field col s12'><input type='button' name='submitbtn' id='submitbtn' style='margin-left: -501px;' class='btn' value='Submit' onclick='verfymc()' disabled='true'/> </div>";
                    ...
                    echo "<div class='input-field col s12'><input type='button' name='submitbtn' id='submitbtn' style='margin-left: -501px;' class='btn' value='Submit' onclick='codeerr()' disabled='true'/>  </div>";
                }
                ?>
            </div>
