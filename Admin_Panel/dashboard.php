            ...
            <div class="col s12">
                <div class="card blue-grey darken-1 row" style="width: 100%;">
                    ...
                    <div class="card-content white-text center col s12 m6" style="width: 25%">
                        ...
                        <?php echo "Today, " . date('d l') . " : &#8377;" . $atotal; ?>(<?php if ($ax == NULL) {
                            echo "0";
                        } else {
                            echo $ax;
                        } ?> Orders)<br>
<?php echo "This Month, " . date('F') . " : &#8377;" . $total; ?>(<?php if ($sx == NULL) {
    echo "0";
} else {
    echo $sx;
} ?> Orders)<br>
                        <?php echo "This Year, " . date('Y') . " : &#8377;" . $ytotal; ?>(<?php if ($yx == NULL) {
                            echo "0";
                        } else {
                            echo $yx;
                        } ?> Orders)<br>
                        <?php echo "All Time : &#8377;" . $attotal; ?>(<?php if ($yyx == NULL) {
                            echo "0";
                        } else {
                            echo $yyx;
                        } ?> Orders)
...
<?php echo "Today, " . date("d l") . " : " . $xz11['prd_name'] . "";
if ($xz1['nos'] == NULL) {
    echo "(0";
} else {
    echo "(" . $xz1['nos'];
}; ?> Kg/Pc)<br>
<?php echo "This Month, " . date("F") . " : " . $xxz11['prd_name'] . "";
if ($xz1['nos'] == NULL) {
    echo "(0";
} else {
    echo "(" . $xz1['nos'];
...
<?php for ($i = 1; $i < 13; $i++) { ?>    
                                        <option value="<?php echo $i ?>"><?php $dateObj = DateTime::createFromFormat('!m', $i);
        ...
        <script>
                                        ...
                                        if (str === "year")
                                        {
                                            ...
                                            xmlhttp.onreadystatechange = function ()
                                            {
                                                if (xmlhttp.readyState === 4 && xmlhttp.status === 200)
                                                {
                                                    ...
                                                    {
                                                        if (obj[i].ord_total == null) {
                                                            date.push("0");
                                                            date1.push("0");
                                                        } else {
                                                            date.push(obj[i].ord_total);
                                                            date1.push(obj[i].total);
                                                        }
                                                    }
                                    ...
                                    function selectchart()
                                    {
                                        ...
                                        if (a == "custom") {
                                            ...
                                            $("#month").hide();
                                            $("#custom").hide();
                                            changechart(a, $('#yearsel').val());
                                        } else if (a == "month") {
                                            $("#year").hide();
                                            $("#month").show();
                                            $("#custom").hide();
                                            changechart(a, $('#monthsel').val());
                                        }
                                    }
