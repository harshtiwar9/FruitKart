...
$total_price = 0;
$i = 1;
$sql1 = "SELECT * FROM order_products WHERE ord_id=" . $ordId . "";
...
while ($row1 = mysqli_fetch_array($result1)) {
    ...
    while ($row2 = mysqli_fetch_array($result2)) {
        ...
        $pdf->Cell(25, 10, $row2["prd_mrp"], 0, 0, "C");
        if ($row1['oprd_qty'] == "500 GM") {
            $price = 1 * $row2['prd_mrp'];
        } elseif ($row1['oprd_qty'] == "1 KG") {
            $price = 2 * $row2['prd_mrp'];
        } elseif ($row1['oprd_qty'] == "1.5 KG") {
            $price = 3 * $row2['prd_mrp'];
        } elseif ($row1['oprd_qty'] == "2 KG") {
            $price = 4 * $row2['prd_mrp'];
        } elseif ($row1['oprd_qty'] == "2.5 KG") {
            $price = 5 * $row2['prd_mrp'];
        } elseif ($row1['oprd_qty'] == "3 KG") {
            $price = 6 * $row2['prd_mrp'];
        } elseif ($row1['oprd_qty'] == "3.5 KG") {
            $price = 7 * $row2['prd_mrp'];
        } elseif ($row1['oprd_qty'] == "4 KG") {
            $price = 8 * $row2['prd_mrp'];
        } elseif ($row1['oprd_qty'] == "4.5 KG") {
            $price = 9 * $row2['prd_mrp'];
        } elseif ($row1['oprd_qty'] == "5 KG") {
