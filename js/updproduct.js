function updproduct()
{
                ...
                var f=document.getElementById("prod_id").value;
                var xmlhttp;
               ...
               xmlhttp.open("POST","../logic.php?page=updateproduct",true);
               xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
               xmlhttp.send("prod_name="+a+"&prod_category="+b+"&prod_mrp="+c+"&prod_quantity="+d+"&prod_about="+e+"&prod_id="+f);
}